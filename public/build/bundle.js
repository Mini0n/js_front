...
var app = (function () {
    ...
    function create_then_block(ctx) {
    	let p;
    	let t0_value = ctx.value + "";
    	let t0;
    	let t1;
    	let t2_value = (ctx.value === 1 ? "product" : "products") + "";
    	let t2;
    	let t3;
    	let t4;
    	let table;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 37, 2, 701);
    			add_location(tbody, file$3, 39, 3, 775);
    			attr_dev(table, "class", "svelte-1y0jqd5");
    			add_location(table, file$3, 38, 2, 764);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    		...
    		p: function update(changed, ctx) {
    			if ((!current || changed.promise_products) && t0_value !== (t0_value = ctx.value + "")) set_data_dev(t0, t0_value);
    			if ((!current || changed.promise_products) && t2_value !== (t2_value = (ctx.value === 1 ? "product" : "products") + "")) set_data_dev(t2, t2_value);
    ...
    // (41:4) {#each products as prod (prod.id)}
    function create_each_block(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(41:4) {#each products as prod (prod.id)}",
    		ctx
    	});
    ...
    function create_pending_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "pending",
    		source: "(35:26)    <Loading/>  {:then value}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "Reload products";
    			add_location(pre, file$3, 32, 5, 618);
    			attr_dev(h1, "class", "svelte-1y0jqd5");
    			add_location(h1, file$3, 32, 1, 614);
    			add_location(br, file$3, 51, 1, 1058);
    			add_location(button, file$3, 52, 1, 1064);
    			attr_dev(main, "class", "svelte-1y0jqd5");
    			add_location(main, file$3, 31, 0, 606);
    			dispose = listen_dev(button, "click", ctx.promiseClick, false, false, false);
    		},
    		l: function claim(nodes) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("app_status" in $$props) app_status = $$props.app_status;
    	...
    	return { products, promise_products, promiseClick };
    }
